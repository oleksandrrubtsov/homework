...
ALTER TABLE public._company_view OWNER TO rebasedata;
...
ALTER TABLE public._countries OWNER TO rebasedata;
...
ALTER TABLE public._department OWNER TO rebasedata;
...
ALTER TABLE public._departments OWNER TO rebasedata;

--
-- Name: _details; Type: TABLE; Schema: public; Owner: rebasedata
--

CREATE TABLE public._details (
    ...
    turn character varying(1) DEFAULT NULL::character varying
);


ALTER TABLE public._details OWNER TO rebasedata;

--
-- Name: _emor; Type: TABLE; Schema: public; Owner: rebasedata
--

CREATE TABLE public._emor (
    id character varying(1) DEFAULT NULL::character varying,
    name character varying(1) DEFAULT NULL::character varying
);


ALTER TABLE public._emor OWNER TO rebasedata;

--
-- Name: _employee_data; Type: TABLE; Schema: public; Owner: rebasedata
--

CREATE TABLE public._employee_data (
    employee_name character varying(1) DEFAULT NULL::character varying,
    item character varying(1) DEFAULT NULL::character varying,
    rate character varying(1) DEFAULT NULL::character varying,
...
ALTER TABLE public._employee_data OWNER TO rebasedata;

--
-- Name: _employee_income; Type: TABLE; Schema: public; Owner: rebasedata
--

CREATE TABLE public._employee_income (
    empid character varying(1) DEFAULT NULL::character varying,
    name character varying(1) DEFAULT NULL::character varying,
    salary character varying(1) DEFAULT NULL::character varying
);


ALTER TABLE public._employee_income OWNER TO rebasedata;
...
--
-- Name: _esercicio1; Type: TABLE; Schema: public; Owner: rebasedata
--

CREATE TABLE public._esercicio1 (
    c character varying(1) DEFAULT NULL::character varying,
    d character varying(1) DEFAULT NULL::character varying
);


ALTER TABLE public._esercicio1 OWNER TO rebasedata;
...
ALTER TABLE public._job_history OWNER TO rebasedata;
...
ALTER TABLE public._min_salary OWNER TO rebasedata;
...
ALTER TABLE public._prod_backup OWNER TO rebasedata;
...
ALTER TABLE public._prod_mast OWNER TO rebasedata;
...
ALTER TABLE public._regions OWNER TO rebasedata;

--
-- Name: _student; Type: TABLE; Schema: public; Owner: rebasedata
--

CREATE TABLE public._student (
    id character varying(1) DEFAULT NULL::character varying,
    name character varying(1) DEFAULT NULL::character varying,
    age character varying(1) DEFAULT NULL::character varying,
    address character varying(1) DEFAULT NULL::character varying,
    fees character varying(1) DEFAULT NULL::character varying
);


ALTER TABLE public._student OWNER TO rebasedata;
...
ALTER TABLE public._tb1 OWNER TO rebasedata;
...
ALTER TABLE public._view_min_sal OWNER TO rebasedata;

--
-- Name: r; Type: TABLE; Schema: public; Owner: rebasedata
--

CREATE TABLE public.r (
    a character varying(1) DEFAULT NULL::character varying,
    b character varying(1) DEFAULT NULL::character varying
);


ALTER TABLE public.r OWNER TO rebasedata;

--
-- Name: s; Type: TABLE; Schema: public; Owner: rebasedata
--
...
ALTER TABLE public.s OWNER TO rebasedata;
...
--
-- Data for Name: _details; Type: TABLE DATA; Schema: public; Owner: rebasedata
--

COPY public._details (id, name, weight, turn) FROM stdin;
\.


--
-- Data for Name: _emor; Type: TABLE DATA; Schema: public; Owner: rebasedata
--

COPY public._emor (id, name) FROM stdin;
\.


--
-- Data for Name: _employee_data; Type: TABLE DATA; Schema: public; Owner: rebasedata
--

COPY public._employee_data (employee_name, item, rate, quantity, date, id) FROM stdin;
\.


--
-- Data for Name: _employee_income; Type: TABLE DATA; Schema: public; Owner: rebasedata
--

COPY public._employee_income (empid, name, salary) FROM stdin;
\.
...
--
-- Data for Name: _esercicio1; Type: TABLE DATA; Schema: public; Owner: rebasedata
--

COPY public._esercicio1 (c, d) FROM stdin;
\.
...
--
-- Data for Name: _student; Type: TABLE DATA; Schema: public; Owner: rebasedata
--

COPY public._student (id, name, age, address, fees) FROM stdin;
\.
...
COPY public._tags (title, description, created) FROM stdin;
\.
...
COPY public._users (name, email) FROM stdin;
\.
...
--
-- Data for Name: r; Type: TABLE DATA; Schema: public; Owner: rebasedata
--

COPY public.r (a, b) FROM stdin;
\.


--
-- Data for Name: s; Type: TABLE DATA; Schema: public; Owner: rebasedata
--

COPY public.s (a, d, e) FROM stdin;
\.
